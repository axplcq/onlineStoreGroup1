...
[Eric Hedgepeth](mailto:ehedgepe@uncc.edu)
- **G-1:** `Wishlist`
  - **Definition:** A feature that allows customers to save and track products they are interested in but not ready to purchase. Customers can add products to their wishlist for future reference, compare them, or easily add them to the cart when ready to make a purchase.
