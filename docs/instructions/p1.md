...
- **REQ-1:** Order Confirmation Email
...
- **REQ-2:** Account Registration and Guest Checkout
...
- **REQ-3:** Quantity Adjustment in the Shopping Cart
...
- **REQ-1:** Real-Time Inventory Management
...
- **REQ-2:** Order Tracking and Shipment Notifications
...
[Eric Hedgepeth](mailto:ehedgepe@uncc.edu)
- **CON-1:** Performance and Scalability
...
- **CON-2:** First Major Project with Collaboration
...
- **CON-2:** User Experience Design Constraints
  - **Description:**  This project represents the first major collaborative project for some team members, with a focus on effective communication, coordination, and division of tasks among team members. 
...
[Eric Hedgepeth](mailto:ehedgepe@uncc.edu)
- **UC-1:** Account Registration and Profile Setup
...
- **US-1:** Personalized Product Recommendations
  - **Type of User:** Customer
...
- **US-2:** Contacting Customer Support
  - **Type of User:** Customer
...
- **G-1:** `Lost my username/password`
  - **Definition:** A Customer is trying to login to their account, but forgot one or more of their credentials. The login card will display a 'forgot username/password' option link which will help the user to retrieve the detishlist`
